...
const CreateEmployee = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const { data } = await axios.post('/api/employees', formDataToSend, config);
      console.log(data);
    } catch (error) {
      console.error(error);
    }
      ...
      <div className="create-employee-content">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <fieldset>
            ...
            <input type="checkbox" id="mca" name="course" value="MCA" checked={formData.course === 'MCA'} onChange={handleChange} />
            <label htmlFor="mca">MCA</label>
            <input type="checkbox" id="bca" name="course" value="BCA" checked={formData.course === 'BCA'} onChange={handleChange} />
            <label htmlFor="bca">BCA</label>
            <input type="checkbox" id="bsc" name="course" value="BSC" checked={formData.course === 'BSC'} onChange={handleChange} />
